...
fn languages_is_vector_valid() {
    let valid_vec_1: Vec<String> = Vec::from([
        String::from("English"),
        String::from("French"),
        String::from("Italian"),
    ...
    let invalid_vec_3: Vec<String> = Vec::from([
        String::from("English"),
        String::from("Italian"),
        String::from("English"),
    ]);
    ...
    assert_eq!(
        is_vector_valid(&invalid_vec_1),
        "Vector has duplicated languages"
    );
    assert_eq!(
        is_vector_valid(&invalid_vec_2),
        "Vector has null element(s)"
    );
    assert_eq!(
        is_vector_valid(&invalid_vec_3),
        "Vector has null element(s)"
    );
}
